...
export default {
  ...
  "baseUrl": "/docs/",
  "trailingSlash": true,
  "organizationName": "breadcrumb-team",
  "projectName": "docs",
  "onBrokenLinks": "warn",
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Breadcrumb Technologies Inc."
    },
    "prism": {
      "theme": {
        "plain": {
  ...
  "plugins": [
    [
      "/home/ubuntu/repos/docs/node_modules/@easyops-cn/docusaurus-search-local/dist/server/server/index.js",
      {
        "hashed": true
      }
    ]
